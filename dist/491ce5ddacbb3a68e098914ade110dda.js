...
},{"object-assign":76,"fbjs/lib/emptyObject":80,"fbjs/lib/emptyFunction":83}],95:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./emptyFunction":83}],93:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"fbjs/lib/invariant":95,"fbjs/lib/warning":96,"./lib/ReactPropTypesSecret":93}],26:[function(require,module,exports) {
/** @license React v16.2.0
...
},{"object-assign":76,"fbjs/lib/emptyObject":80,"fbjs/lib/invariant":95,"fbjs/lib/warning":96,"fbjs/lib/emptyFunction":83,"prop-types/checkPropTypes":79}],22:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react.production.min.js":25,"./cjs/react.development.js":26}],84:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"./emptyFunction":83}],82:[function(require,module,exports) {
'use strict';
...
},{"./isNode":112}],86:[function(require,module,exports) {
'use strict';
...
},{"./isTextNode":94}],87:[function(require,module,exports) {
/**
 * Copyright (c) 2013-present, Facebook, Inc.
 *
 * This source code is licensed under the MIT license found in the
...
},{"react":22,"fbjs/lib/ExecutionEnvironment":84,"object-assign":76,"fbjs/lib/emptyFunction":83,"fbjs/lib/EventListener":81,"fbjs/lib/getActiveElement":82,"fbjs/lib/shallowEqual":85,"fbjs/lib/containsNode":86,"fbjs/lib/focusNode":87,"fbjs/lib/emptyObject":80}],130:[function(require,module,exports) {
'use strict';
...
},{"./hyphenate":130}],131:[function(require,module,exports) {
"use strict";
...
},{"./camelize":131}],28:[function(require,module,exports) {
/** @license React v16.2.0
...
},{"react":22,"fbjs/lib/invariant":95,"fbjs/lib/warning":96,"fbjs/lib/ExecutionEnvironment":84,"object-assign":76,"fbjs/lib/emptyFunction":83,"fbjs/lib/EventListener":81,"fbjs/lib/getActiveElement":82,"fbjs/lib/shallowEqual":85,"fbjs/lib/containsNode":86,"fbjs/lib/focusNode":87,"fbjs/lib/emptyObject":80,"prop-types/checkPropTypes":79,"fbjs/lib/hyphenateStyleName":128,"fbjs/lib/camelizeStyleName":129}],23:[function(require,module,exports) {
'use strict';
...
},{"./cjs/react-dom.production.min.js":27,"./cjs/react-dom.development.js":28}],24:[function(require,module,exports) {
var bundleURL = null;
...
},{"./bundle-url":24}],49:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],43:[function(require,module,exports) {
'use strict';
...
var Nextmenu = function (_Component) {
  _inherits(Nextmenu, _Component);

  function Nextmenu() {
    _classCallCheck(this, Nextmenu);

    return _possibleConstructorReturn(this, (Nextmenu.__proto__ || Object.getPrototypeOf(Nextmenu)).apply(this, arguments));
  }

  _createClass(Nextmenu, [{
    key: 'exportProject',
    ...
    value: function componentDidMount() {
      ...
      this.fileInput.addEventListener('change', function (event) {
        ...
        editor.loader.loadFile(_this2.fileInput.files[0]);
        form.reset();
      });
      ...
      this.saveString = function (text, filename) {
        ...
        _this2.save(new Blob([text], { type: 'text/plain' }), filename);
      };
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'ul',
        { className: 'gra-next-menu ' + (this.props.isActive ? 'active' : '') },
        this.props.children.map(function (item) {
          return _react2.default.createElement(
            'li',
            {
              className: 'gra-next-menu-item',
              onClick: item.func ? _this3[item.func].bind(_this3) : null,
              key: item.title },
            item.title
          );
        })
...
},{"react":22,"./Nextmenu.scss":49}],42:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],41:[function(require,module,exports) {
module.exports = [
  {
    "title": "文件",
    "isActive": false,
...
var _Nextmenu = require('./Nextmenu');

var _Nextmenu2 = _interopRequireDefault(_Nextmenu);

require('./Menubar.scss');

var _menuData = require('../../common/menuData.json');
...
var Menubar = function (_Component) {
  ...
  _createClass(Menubar, [{
    key: 'changeFocus',
    value: function changeFocus(index, e) {
      this.setState(function (o, n) {
        var menuFocus = !o.menuFocus;

        var data = o.data.map(function (item) {
          item.isActive = false;
          return item;
        });
        if (menuFocus) {
    ...
    key: 'checkFocus',
    value: function checkFocus(index, e) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'ul',
        { className: 'gra-menu-bar' },
        data.map(function (item, i) {
          return _react2.default.createElement(
            'li',
            {
              className: 'gra-menu-item ' + (item.isActive ? 'active' : ''),
              onMouseEnter: _this2.checkFocus.bind(_this2, i),
              onClick: _this2.changeFocus.bind(_this2, i),
              key: item.title },
            item.title,
            ' ',
            _react2.default.createElement('i', { className: 'iconfont icon-xia gra-icon-xia' }),
            _react2.default.createElement(_Nextmenu2.default, { isActive: item.isActive, children: item.children })
          );
        })
      );
    }
...
},{"react":22,"./Nextmenu":43,"./Menubar.scss":42,"../../common/menuData.json":41}],39:[function(require,module,exports) {
...
exports.language = exports.logo = undefined;

var _logo = require('../../assets/image/logo.png');

var _logo2 = _interopRequireDefault(_logo);

var _language = require('../../assets/image/language.png');
...
},{"../../assets/image/logo.png":39,"../../assets/image/language.png":40}],31:[function(require,module,exports) {
...
var Header = function (_Component) {
  ...
  _createClass(Header, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'header',
        { className: 'gra-header' },
        _react2.default.createElement(
          'div',
          { className: 'gra-avatar-wrapper' },
          _react2.default.createElement('img', { src: _images.logo, className: 'gra-logo' }),
          _react2.default.createElement(
            'a',
            { className: 'gra-logo-title', href: 'javascript:;' },
            '3D\u56FE\u5F62\u7F16\u7A0B'
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'gra-language-selector' },
          _react2.default.createElement('i', { className: 'iconfont icon-diqiu gra-icon-language' })
        ),
...
},{"react":22,"./Menubar":32,"../../common/images":30,"./Header.scss":31}],46:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],44:[function(require,module,exports) {
module.exports="/dist/6266afa47f221d355b798c480308ba71.png";
  ...
  _createClass(Screen, [{
    ...
    value: function changeMode() {
      ...
      function getFullScreen() {
        ...
        var wHeight = window.innerHeight - 17;
      ...
      function setPlayerInterval(wWidth) {
        var timer = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 10;
    ...
    value: function changeState(state) {
      ...
      if (state === 'isStarted') {
        ...
        this.setState((_setState = {}, _defineProperty(_setState, state, true), _defineProperty(_setState, 'isEnded', false), _setState));
      } else {
        var _setState2;

        signals.stopPlayer.dispatch();

        this.setState((_setState2 = {}, _defineProperty(_setState2, state, true), _defineProperty(_setState2, 'isStarted', false), _setState2));
      }
    }
  }, {
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      setTimeout(function () {
        window.editor.signals.positionInfo.add(function (_ref) {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'section',
        {
          ...
          ref: function ref(screenWrapper) {
            return _this3.screenWrapper = screenWrapper;
          } },
        _react2.default.createElement(
          'div',
          { className: 'gra-screen-header' },
          _react2.default.createElement('i', { onClick: this.changeMode.bind(this), className: 'iconfont icon-quanping gra-icon-full-screen', title: '\u5168\u5C4F' }),
          _react2.default.createElement('i', { onClick: this.changeState.bind(this, 'isEnded'), className: 'iconfont icon-circle gra-icon-end ' + (this.state.isEnded ? 'active' : '') }),
          _react2.default.createElement('i', { onClick: this.changeState.bind(this, 'isStarted'), className: 'iconfont icon-qizi gra-icon-start ' + (this.state.isStarted ? 'active' : '') })
        ),
        _react2.default.createElement(
          'div',
          { className: 'gra-screen-main' },
          _react2.default.createElement(
            'div',
            { className: 'gra-screen-main-container', id: 'gra-screen-main-player' },
            _react2.default.createElement('img', { src: require('../../../assets/image/guide.png') })
          )
        ),
        _react2.default.createElement(
          'div',
          { className: 'gra-screen-footer' },
          _react2.default.createElement(
            'span',
            { className: 'gra-screen-x' },
            '\u4F4D\u7F6E: '
          ),
          _react2.default.createElement(
            'span',
          ...
          _react2.default.createElement(
            'span',
            { className: 'gra-screen-y' },
            '\u7F29\u653E: '
          ),
          _react2.default.createElement(
            'span',
            { className: 'gra-screen-z' },
            _sx
          ),
          _react2.default.createElement(
            'span',
...
},{"react":22,"./Screen.scss":46,"../../../assets/image/guide.png":44}],45:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],91:[function(require,module,exports) {
'use strict';
...
const isThenable = exports.isThenable = arg => typeof arg === 'object' && typeof arg.then === 'function';
...
exports.argsToParams = undefined;

var _utils = require('../utils/utils.js');

const argsToParams = exports.argsToParams = args => {
  const params = {};
...
},{"../utils/utils.js":91}],103:[function(require,module,exports) {
"use strict";
 ...
 */
const adaptInputValidator = exports.adaptInputValidator = legacyValidator => {
...
},{"../classes":113}],123:[function(require,module,exports) {
'use strict';
...
const getFocusableElements = exports.getFocusableElements = () => {
  ...
  const otherFocusableElements = Array.prototype.slice.call(getPopup().querySelectorAll('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable], audio[controls], video[controls]'));
...
},{"../classes":113,"../utils":91}],127:[function(require,module,exports) {
'use strict';
...
},{"../classes":113,"./getters":123,"./domUtils":121,"../isNodeEnv":127,"../utils":91,"../../sweetalert2":77}],124:[function(require,module,exports) {
'use strict';
...
},{"./domUtils":121}],125:[function(require,module,exports) {
'use strict';
...
},{"../isNodeEnv":127}],126:[function(require,module,exports) {
'use strict';
...
},{"./domUtils":121,"./init":122,"./getters":123,"./parseHtmlToContainer":124,"./animationEndEvent":125,"./measureScrollbar":126}],118:[function(require,module,exports) {
'use strict';
...
},{"./dom/index":117}],119:[function(require,module,exports) {
'use strict';
...
},{"./dom/index":117,"../utils/classes":113}],111:[function(require,module,exports) {
'use strict';
...
},{"../utils/utils":91}],114:[function(require,module,exports) {
'use strict';
...
},{"./utils/params.js":111}],105:[function(require,module,exports) {
'use strict';
...
const close = (onClose, onAfterClose) => {
  ...
  if (!dom.isToast()) {
    dom.resetPrevState();
    window.onkeydown = _globalState2.default.previousWindowKeyDown;
    _globalState2.default.windowOnkeydownOverridden = false;
  }
...
},{"../utils/scrollbarFix":118,"../utils/iosFix":119,"../utils/dom/index":117,"../utils/classes.js":113,"../globalState":114}],104:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.clickCancel = exports.clickConfirm = exports.isVisible = exports.isLoading = exports.getFooter = exports.getCancelButton = exports.getConfirmButton = exports.getActions = exports.getButtonsWrapper = exports.getImage = exports.getContent = exports.getTitle = undefined;
 ...
 */
const isVisible = exports.isVisible = () => {
  return !!dom.getPopup();
};
 ...
 */
const clickConfirm = exports.clickConfirm = () => dom.getConfirmButton().click();

/*
 * Global function to click 'Cancel' button
 */
const clickCancel = exports.clickCancel = () => dom.getCancelButton().click();
},{"../utils/dom/index":117}],106:[function(require,module,exports) {
"use strict";
...
exports.resetDefaults = exports.setDefaults = undefined;
 ...
 */
const setDefaults = exports.setDefaults = userParams => {
  ...
  for (const param in userParams) {
    if ((0, _params.isValidParameter)(param)) {
      _globalState2.default.popupParams[param] = userParams[param];
    }
  }
};
 ...
 */
const resetDefaults = exports.resetDefaults = () => {
  _globalState2.default.popupParams = Object.assign({}, _params2.default);
};
},{"../utils/utils":91,"../utils/params":111,"../globalState":114}],109:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.enableLoading = exports.showLoading = undefined;
...
},{"../utils/dom/index":117,"../sweetalert2":77,"../utils/classes":113}],110:[function(require,module,exports) {
"use strict";
...
var _argsToParams = require('./staticMethods/argsToParams');
...
var _adaptInputValidator = require('./staticMethods/adaptInputValidator');

Object.keys(_adaptInputValidator).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _adaptInputValidator[key];
    }
  });
});

var _close = require('./staticMethods/close');
...
var _dom = require('./staticMethods/dom');
...
var _mixin = require('./staticMethods/mixin');
...
var _queue = require('./staticMethods/queue');
...
var _setResetDefaults = require('./staticMethods/set-reset-defaults');

Object.keys(_setResetDefaults).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _setResetDefaults[key];
    }
  });
});

var _showLoading = require('./staticMethods/showLoading');
...
var _fire = require('./staticMethods/fire');
...
},{"./staticMethods/argsToParams":102,"./staticMethods/adaptInputValidator":103,"./staticMethods/close":105,"./staticMethods/dom":104,"./staticMethods/mixin":106,"./staticMethods/queue":107,"./staticMethods/set-reset-defaults":108,"./staticMethods/showLoading":109,"./staticMethods/fire":110,"./utils/params":111}],97:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.disableLoading = exports.hideLoading = undefined;
...
},{"../utils/dom/index":117,"../utils/classes":113}],101:[function(require,module,exports) {
'use strict';
...
},{"../utils/dom/index":117,"../utils/classes":113}],98:[function(require,module,exports) {
'use strict';
...
},{"../utils/dom/index":117,"../utils/classes":113}],120:[function(require,module,exports) {
'use strict';
...
},{"./classes.js":113,"./utils.js":91,"./dom/index":117,"../sweetalert2":77,"./defaultInputValidators":120}],116:[function(require,module,exports) {
'use strict';
...
var _scrollbarFix = require('./scrollbarFix');

var _iosFix = require('./iosFix');
 ...
 * @param onComplete
 */
const openPopup = exports.openPopup = (animation, onBeforeOpen, onOpen) => {
  const container = dom.getContainer();
  const popup = dom.getPopup();
...
},{"./dom/index":117,"./classes":113,"./scrollbarFix":118,"./iosFix":119}],100:[function(require,module,exports) {
'use strict';
...
function _main(userParams) {
  ...
  const params = this.params = Object.assign({}, _globalState2.default.popupParams, userParams);
  ...
  return new Promise((resolve, reject) => {
    ...
    if (params.toast && _globalState2.default.windowOnkeydownOverridden) {
      window.onkeydown = _globalState2.default.previousWindowKeyDown;
      _globalState2.default.windowOnkeydownOverridden = false;
    }

    if (!params.toast && !_globalState2.default.windowOnkeydownOverridden) {
      _globalState2.default.previousWindowKeyDown = window.onkeydown;
      _globalState2.default.windowOnkeydownOverridden = true;
    ...
    if (params.input === 'select' || params.input === 'radio') {
      ...
      if ((0, _utils.isThenable)(params.inputOptions)) {
    ...
    } else if (['text', 'email', 'number', 'tel', 'textarea'].includes(params.input) && (0, _utils.isThenable)(params.inputValue)) {
      constructor.showLoading();
      dom.hide(input);
    ...
    (0, _openPopup.openPopup)(params.animation, params.onBeforeOpen, params.onOpen);
...
},{"../utils/params":111,"../utils/dom/index":117,"../utils/classes":113,"../utils/utils":91,"../utils/setParameters":115,"../globalState":114,"../utils/openPopup":116}],90:[function(require,module,exports) {
'use strict';
...
var _hideLoading = require('./instanceMethods/hideLoading');
...
var _getInput = require('./instanceMethods/getInput');
...
var _enableDisableElements = require('./instanceMethods/enable-disable-elements');
...
var _showResetValidationError = require('./instanceMethods/show-reset-validation-error');
...
var _main = require('./instanceMethods/_main');
...
},{"./instanceMethods/hideLoading":97,"./instanceMethods/getInput":101,"./instanceMethods/enable-disable-elements":98,"./instanceMethods/show-reset-validation-error":99,"./instanceMethods/_main":100}],77:[function(require,module,exports) {
'use strict';
...
},{"./utils/utils.js":91,"./utils/DismissReason":92,"../package.json":88,"./staticMethods":89,"./instanceMethods":90}],34:[function(require,module,exports) {
'use strict';
...
var Editor = function (_Component) {
  ...
  _createClass(Editor, [{
    ...
    key: 'makeNewRole',
    value: function makeNewRole() {
      console.log((0, _sweetalert2.default)('暂不支持角色建模，请从素材库中选择素材'));
    }
  }, {
    key: 'componentDidMount',
    value: function componentDidMount() {
      ...
      this.colorPicker.onchange = function (e) {
        editor.signals.sceneBackgroundChanged.dispatch(parseInt(_this2.colorPicker.value.substr(1), 16));
      };
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      return _react2.default.createElement(
        'section',
        { className: 'gra-editor-wrapper' },
        _react2.default.createElement(
          'div',
          { className: 'gra-editor-header' },
          _react2.default.createElement('div', { className: 'gra-editor-header-block' }),
          _react2.default.createElement(
            'div',
            { className: 'gra-editor-header-role' },
            _react2.default.createElement(
              'span',
              { className: 'gra-editor-role-title' },
              '\u7D20\u6750'
            ),
            _react2.default.createElement(
              'span',
              ...
              _react2.default.createElement('i', { className: 'iconfont icon-huabi gra-icon-draw', onClick: this.makeNewRole.bind(this) }),
        ...
        _react2.default.createElement(
          'div',
          { className: 'gra-editor-main' },
          _react2.default.createElement(
            'div',
            { className: 'gra-editor-main-bgeditor' },
            _react2.default.createElement(
              'div',
              {
              ...
              _react2.default.createElement(
                'p',
                { className: 'gra-editor-main-bgimg-title' },
                '\u821E\u53F0'
              ),
              _react2.default.createElement(
                'p',
                { className: 'gra-editor-main-bgimg-title' },
                bgImgTitle ? bgImgTitle : '新建背景'
              )
            ),
            _react2.default.createElement(
              'div',
              { className: 'gra-editor-main-bgimg-edit-wrapper' },
              _react2.default.createElement(
                'h4',
                { className: 'gra-editor-main-bgimg-edit-title' },
                '\u65B0\u5EFA\u80CC\u666F'
              ),
              _react2.default.createElement(
                'span',
                ...
                _react2.default.createElement('i', { className: 'iconfont icon-huabi gra-icon-draw', title: '\u4FEE\u6539\u80CC\u666F\u989C\u8272', onClick: this.changeBackgroundColor.bind(this) }),
                _react2.default.createElement('i', { className: 'iconfont icon-shangchuan1 gra-icon-upload' }),
                _react2.default.createElement('i', { className: 'iconfont icon-xiangji gra-icon-camera' })
              )
            )
          ),
          _react2.default.createElement('div', { className: 'gra-editor-main-role-wrapper', id: 'gra-role-wrapper' })
        )
      );
    }
  }]);
...
},{"react":22,"./Editor.scss":45,"sweetalert2":77}],67:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],48:[function(require,module,exports) {
'use strict';
...
var Tablist = function (_Component) {
  ...
  _createClass(Tablist, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        { className: 'gra-content-tab-list' },
        _react2.default.createElement(
          'ul',
          ...
          tabList.map(function (item, i) {
            ...
            return _react2.default.createElement(
              'li',
              {
                ...
                onClick: _this2.changeIndex.bind(_this2, i),
                key: item },
              item
            );
          })
...
},{"react":22,"./Tablist.scss":67}],47:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],73:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],69:[function(require,module,exports) {
'use strict';
  ...
  _createClass(Script, [{
    ...
    value: function componentDidMount() {
      ...
      function myUpdateFunction(event) {
        ...
        var script = object.uuid && editor.scripts[object.uuid] && editor.scripts[object.uuid][0];
...
},{"react":22,"./Script.scss":73}],75:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],70:[function(require,module,exports) {
'use strict';
...
var Voice = function (_Component) {
  ...
  _createClass(Voice, [{
    ...
    value: function componentDidMount() {
      ...
      this.processWrapper.addEventListener('mousedown', function (e) {

        var preClientX = e.clientX;
        var wholeWidth = _this2.processWrapper.offsetWidth;
        var currentX = e.offsetX;

        var currentWidth = (currentX / wholeWidth * 100).toFixed(0);

        _this2.currentProcess.style.width = currentWidth + '%';
        ...
        function processMove(e) {
          ...
          var _delta = currentClientX - preClientX;

          var newCurrentX = currentX + _delta;

          newCurrentX = newCurrentX < 0 ? 0 : newCurrentX > wholeWidth ? wholeWidth : newCurrentX;
        ...
        function processUp(e) {
          ...
          var currentTime = self.currentProcess.style.width.replace('%', '') - 0;
      ...
      function getNewFile(e) {
        if (e.target.files && e.target.files.length) {
          ...
          var voiceList = self.state.voiceList;


          self.setState({
            voiceList: [].concat(_toConsumableArray(voiceList), [{
              name: file.name,
              key: url
            }])
          }, function () {
            editor.voices[file.name] = { url: url, path: path };
    ...
    key: 'checkVoice',
    value: function checkVoice(item, i) {
      var _this3 = this;
      ...
      setTimeout(function () {
        ...
        _this3.setTime(_this3.videoAudio.duration);
      }, 100);
    ...
    value: function checkState(e) {
      ...
      if (target.innerText === '播放') {
        ...
        interval = setInterval(function () {
          ...
          _this4.setTime(_this4.videoAudio.currentTime, 'currentTime');

          if (_this4.videoAudio.currentTime === _this4.videoAudio.duration) {
    ...
    key: 'choseFile',
    value: function choseFile(e) {
      this.fileInput.click();
    }
  }, {
    key: 'removeVoice',
    value: function removeVoice(e) {
      var _state = this.state,
          voiceIndex = _state.voiceIndex,
          voiceList = _state.voiceList;
    ...
    value: function setTime(time) {
      var key = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 'wholeTime';
      ...
      this.setState(_defineProperty({}, key, result));
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var _state2 = this.state,
          voiceList = _state2.voiceList,
          voiceIndex = _state2.voiceIndex,
          voice = _state2.voice,
          currentTime = _state2.currentTime,
          wholeTime = _state2.wholeTime;


      return _react2.default.createElement(
        'section',
        { className: 'gra-content-voice-editor' },
        _react2.default.createElement(
          'div',
          { className: 'gra-content-voice-left-wrapper' },
          _react2.default.createElement(
            'h4',
            { className: 'gra-content-voice-left-header' },
            '\u65B0\u5EFA\u58F0\u97F3'
          ),
          _react2.default.createElement(
            'div',
            { className: 'gra-content-btn-wrapper' },
            _react2.default.createElement(
              'a',
              { href: 'javascript:;', className: 'btn btn-default', onClick: this.choseFile.bind(this) },
              '\u5BFC\u5165'
            ),
            _react2.default.createElement(
              'a',
              { href: 'javascript:;', className: 'btn btn-danger', onClick: this.removeVoice.bind(this) },
              '\u5220\u9664'
            )
          ),
          _react2.default.createElement(
            'ul',
            { className: 'gra-content-voice-list' },
            voiceList.map(function (item, i) {
              return _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'div',
                  { className: 'gra-content-voice-item-content ' + (voiceIndex === i ? 'active' : ''), onClick: _this5.checkVoice.bind(_this5, item, i) },
                  item.name
                )
              );
            })
        ...
        _react2.default.createElement(
          'div',
          { className: 'gra-content-voice-right-wrapper' },
          _react2.default.createElement(
            'div',
            { className: 'gra-content-voice-right-content' },
            _react2.default.createElement(
              'div',
              { className: 'gra-content-voice-item-wrapper', style: { display: voiceIndex !== -1 ? 'inherit' : 'none' } },
              _react2.default.createElement(
                'h4',
                { className: 'gra-content-voice-item-title' },
                voice.name
              ),
              _react2.default.createElement(
                'div',
                { className: 'process-wrapper', ref: function ref(processWrapper) {
                    return _this5.processWrapper = processWrapper;
                  } },
                _react2.default.createElement('p', { className: 'process-all' }),
                _react2.default.createElement('p', { className: 'process-current', ref: function ref(currentProcess) {
                    return _this5.currentProcess = currentProcess;
                  } })
              ),
              _react2.default.createElement(
                'div',
                { className: 'gra-content-voice-item-time' },
                _react2.default.createElement(
                  'p',
                  { className: 'gra-content-voice-time' },
                  currentTime,
                  ' / ',
                  wholeTime
                )
              ...
              _react2.default.createElement(
                'div',
                { className: 'gra-content-voice-control-wrapper' },
                _react2.default.createElement(
                  'a',
                  { href: 'javascript:;', className: 'btn btn-default btn-voice', onClick: this.checkState.bind(this) },
                  '\u64AD\u653E'
                )
              )
            )
        ...
        _react2.default.createElement('audio', { ref: function ref(videoAudio) {
            return _this5.videoAudio = videoAudio;
          } })
      );
    }
  }]);
...
},{"react":22,"./Voice.scss":75}],74:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],71:[function(require,module,exports) {
'use strict';
  ...
  _createClass(Background, [{
        ...
        window.editor.storage.get(function (state) {
          ...
          if (state !== undefined) {
            var _loop = function _loop(key) {
              ...
              state.scripts[key][0].xml = function () {
            ...
            for (var key in state.scripts) {
              _loop(key);
            }

            for (var key in state.voices) {

              var buffer = fs.readFileSync(state.voices[key].path);
              var blob = new Blob([buffer]);
              var url = URL.createObjectURL(blob);
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement('div', { className: 'gra-content-background-editor-container', ref: function ref(container) {
...
},{"react":22,"./Background.scss":74}],72:[function(require,module,exports) {
"use strict";
...
var Handsome = function (_Component) {
  _inherits(Handsome, _Component);

  function Handsome() {
    _classCallCheck(this, Handsome);

    return _possibleConstructorReturn(this, (Handsome.__proto__ || Object.getPrototypeOf(Handsome)).apply(this, arguments));
  }

  _createClass(Handsome, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement(
        "section",
        { className: "gra-content-handsome-editor" },
        "handsome editor"
      );
    }
  }]);
...
},{"react":22}],68:[function(require,module,exports) {
'use strict';

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.Handsome = exports.Voice = exports.Background = exports.Script = undefined;
...
var _Handsome = require('./Handsome');

var _Handsome2 = _interopRequireDefault(_Handsome);
...
},{"./Script":69,"./Voice":70,"./Background":71,"./Handsome":72}],36:[function(require,module,exports) {
'use strict';
...
var Content = function (_Component) {
  ...
  _createClass(Content, [{
    key: 'indexChange',
    value: function indexChange(index) {
      var _this2 = this;
      ...
      this.setState({
        ...
        _this2.background.getCanvasView();
      });
    }
  }, {
    key: 'checkToBackgroundTab',
    value: function checkToBackgroundTab() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Tablist2.default, { getTab: this.indexChange.bind(this), role: this.props.role, ref: function ref(tabList) {
            return _this3.tabList = tabList;
          } }),
        _react2.default.createElement(
          'div',
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(_editors.Background, { ref: function ref(background) {
                return _this3.background = background;
              } })
          ),
          _react2.default.createElement(
            'div',
...
},{"react":22,"./Tablist":48,"./Content.scss":47,"./editors":68}],66:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],50:[function(require,module,exports) {
module.exports="/dist/4dda97cbd21f46ab29ef219fe13471a8.png";
},{}],51:[function(require,module,exports) {
module.exports="/dist/691960d58391147427ef84992d984aff.png";
},{}],52:[function(require,module,exports) {
module.exports="/dist/2d5d928684e1ba09cc6289631cf871e3.png";
},{}],53:[function(require,module,exports) {
module.exports="/dist/31e9681429ced19c1b89a597018ad8e1.png";
},{}],54:[function(require,module,exports) {
module.exports="/dist/dd81daa949a06924a30400a047187b0a.png";
},{}],55:[function(require,module,exports) {
module.exports="/dist/26dfc5ff8caf9840410021e71e9760d9.png";
},{}],56:[function(require,module,exports) {
module.exports="/dist/338eb6349b98a0ed65753e80612014e1.png";
},{}],57:[function(require,module,exports) {
module.exports="/dist/a34888e6f3120af4307db7b8ac969586.png";
},{}],58:[function(require,module,exports) {
module.exports="/dist/ca546eb573bc197ff93eaf8792772a8d.png";
},{}],59:[function(require,module,exports) {
module.exports="/dist/aff94a967e865155c2394e3d323cc391.png";
},{}],60:[function(require,module,exports) {
module.exports="/dist/7d8bf94ddec1df305f46a3a326a15dc7.png";
},{}],61:[function(require,module,exports) {
module.exports="/dist/50f6351bf665cf2c04d23ac576876974.png";
},{}],62:[function(require,module,exports) {
module.exports="/dist/5202fb81a9109645d5c728aff7ca41d7.png";
},{}],63:[function(require,module,exports) {
module.exports="/dist/53614079770d1b20ae6f3008c5366b34.png";
},{}],64:[function(require,module,exports) {
module.exports="/dist/bdbc8b2f505953664d5d808f27025e09.png";
},{}],65:[function(require,module,exports) {
module.exports="/dist/313379688bf732fa9e42ac0b9efe008a.png";
...
var Checkmodal = function (_Component) {
            ...
            children: [{
              ...
              data: [{
                ...
                func: function func() {
                  ...
                  var script = { name: '', source: '', xml: document.querySelector('#function_update') };
  ...
  _createClass(Checkmodal, [{
    ...
    key: 'modelCheck',
    value: function modelCheck(index) {
      this.setState({
        modelIndex: index
      });
    }
      ...
      return showModal ? _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'div',
              { className: 'gra-modal-content-wrapper' },
              _react2.default.createElement(
                'ul',
                { className: 'gra-modal-content-list' },
                models.map(function (item, i) {
                  return _react2.default.createElement(
                    'li',
                    {
                      className: 'gra-modal-content-list-item ' + (modelIndex === i ? 'active' : ''),
                      onClick: _this2.modelCheck.bind(_this2, i),
                      key: item.title },
                    _react2.default.createElement('img', { src: item.avatar, className: 'gra-modal-content-list-item-avatar' }),
                    _react2.default.createElement(
                      'p',
                      { className: 'gra-modal-content-list-item-desc' },
                      item.title
                    )
                  );
                })
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                'a',
                { href: 'javascript:;', className: 'btn btn-primary', onClick: this.addNewModel.bind(this) },
                '\u786E\u5B9A'
              ),
              _react2.default.createElement(
                'a',
...
},{"react":22,"./Checkmodal.scss":66,"../../../assets/image/Group.png":50,"../../../assets/image/Plane.png":51,"../../../assets/image/Box.png":52,"../../../assets/image/Circle.png":53,"../../../assets/image/Cylinder.png":54,"../../../assets/image/Sphere.png":55,"../../../assets/image/Lcosahedron.png":56,"../../../assets/image/Torus.png":57,"../../../assets/image/TorusKnot.png":58,"../../../assets/image/Lathe.png":59,"../../../assets/image/Sprite.png":60,"../../../assets/image/PointLight.png":61,"../../../assets/image/SpotLight.png":62,"../../../assets/image/DirectionalLight.png":63,"../../../assets/image/HemisphereLight.png":64,"../../../assets/image/PerspectiveCamera.png":65}],33:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],18:[function(require,module,exports) {
'use strict';
...
var Container = function (_Component) {
  ...
  _createClass(Container, [{
    ...
    key: 'checkToBackgroundView',
    value: function checkToBackgroundView() {
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'gra-left-wrapper' },
          _react2.default.createElement(
            'div',
            { className: 'gra-left-top-wrapper' },
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_Content2.default, {
            ...
            ref: function ref(contentContainer) {
              return _this3.contentContainer = contentContainer;
            } })
        ),
        _react2.default.createElement(_Checkmodal2.default, {
          role: role,
          checkToBackground: this.checkToBackground.bind(this),
          checkToBackgroundView: this.checkToBackgroundView.bind(this),
          ref: function ref(checkModal) {
            return _this3.checkModal = checkModal;
          } })
      );
    }
  }]);
...
},{"react":22,"./Screen/Screen":35,"./Editor/Editor":34,"./Content/Content":36,"./Checkmodal/Checkmodal":37,"./Container.scss":33}],29:[function(require,module,exports) {
...
var Dragmodal = function (_Component) {
  ...
  function Dragmodal() {
    ...
    var _this = _possibleConstructorReturn(this, (Dragmodal.__proto__ || Object.getPrototypeOf(Dragmodal)).call(this));
    ...
    _this.top = 120;
    _this.left = 640;
    _this.mouseMoveFunction = function (e) {
      if (self.key) {
        var _x = e.clientX - self.preLeft;
        var _y = e.clientY - self.preTop;
  ...
  _createClass(Dragmodal, [{
    ...
    value: function componentDidMount() {
      ...
      window.editor.signals.dragAction.add(function () {
        self.setState(function (o, n) {
          return {
            showModal: !o.showModal
          };
        });
      });
      var material = new Sidebar.Material(editor);
    ...
    key: 'dragOptionModal',
    value: function dragOptionModal(e) {
    ...
    key: 'closeMoveOptionModal',
    value: function closeMoveOptionModal(e) {
      this.key = false;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          ref: function ref(dragModal) {
            return _this2.dragModal = dragModal;
          } },
        _react2.default.createElement(
          'header',
          {
          ...
          '\u6309O\u663E\u793A/\u9690\u85CF',
          _react2.default.createElement('i', { className: 'iconfont icon-iconfontguanbi', onClick: this.closeModal.bind(this) })
        ),
        _react2.default.createElement('section', { className: 'gra-drag-modal-content', ref: function ref(dragContent) {
            return _this2.dragContent = dragContent;
          } })
      );
    }
  }]);
...
},{"react":22,"./Dragmodal.scss":29}],38:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"_css_loader":13}],21:[function(require,module,exports) {
'use strict';
...
var Debugmodal = function (_Component) {
  _inherits(Debugmodal, _Component);

  function Debugmodal() {
    _classCallCheck(this, Debugmodal);

    var _this = _possibleConstructorReturn(this, (Debugmodal.__proto__ || Object.getPrototypeOf(Debugmodal)).call(this));
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'div',
        {
          ...
          ref: function ref(debugModal) {
            return _this3.debugModal = debugModal;
          } },
        _react2.default.createElement(
          'header',
          {
        ...
        _react2.default.createElement(
          'section',
          { className: 'gra-debug-modal-content', ref: function ref(debugContent) {
              return _this3.debugContent = debugContent;
            } },
          _react2.default.createElement('textarea', { id: 'debug-modal-textarea', readOnly: true })
        )
      );
    }
  }]);
...
exports.default = Debugmodal;
},{"react":22,"./Debugmodal.scss":38}],17:[function(require,module,exports) {
...
var _Dragmodal = require('./components/Dragmodal/Dragmodal');

var _Dragmodal2 = _interopRequireDefault(_Dragmodal);

var _Debugmodal = require('./components/Dragmodal/Debugmodal');

var _Debugmodal2 = _interopRequireDefault(_Debugmodal);
  ...
  _createClass(App, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Dragmodal2.default, null),
        _react2.default.createElement(_Debugmodal2.default, null)
      );
    }
  }]);
...
exports.default = App;
},{"react":22,"./components/Header/Header":19,"./components/Container":18,"./components/Dragmodal/Dragmodal":20,"./components/Dragmodal/Debugmodal":21,"./App.scss":17}],11:[function(require,module,exports) {
...
},{"./iconfont.eot":[["52fc726a6e8818256ee0fc6c50b9e084.eot",14],14],"./iconfont.ttf":[["04e0360c30e5af3cd8fde800632c3cf1.ttf",15],15],"./iconfont.svg":[["26565906627a51cc3d91a6dd519f3436.svg",16],16],"_css_loader":13}],9:[function(require,module,exports) {
...
},{"react":22,"react-dom":23,"./src/App":10,"./assets/css/reset.css":11,"./assets/icon/iconfont.css":12,"sweetalert2/dist/sweetalert2.min.css":9}],140:[function(require,module,exports) {
